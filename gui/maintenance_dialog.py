...
class MaintenanceDialog(QDialog):
    ...
    def scan(self):
        ...
        try:
            ...
            QMessageBox.critical(self, self.tr("Error"), self.tr(f"Scan failed: {e}"))
    ...
    def delete_selected_orphans(self):
        ...
        if QMessageBox.question(self, self.tr("Confirm"), self.tr(f"Delete {len(items)} database entries?")) != QMessageBox.StandardButton.Yes:
            return
    ...
    def delete_selected_ghosts(self):
        ...
        if QMessageBox.question(self, self.tr("Confirm"), self.tr(f"Permanently delete {len(items)} files?")) != QMessageBox.StandardButton.Yes:
            return
